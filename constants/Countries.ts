 ...
 * user's call, since most customers are expected to be in Syria.
 *
 * Codes shared by several countries (`1` for the North American Numbering
 * Plan, `7` for Russia and Kazakhstan) are listed once per country, so each
 * country can still be picked by name; the backend validates the full number
 * with libphonenumber, which tells them apart.
 */

export const DEFAULT_COUNTRY = "SY";

export const COUNTRY_DIAL_CODES: readonly { iso: string; dial: string }[] = [
  { iso: "AF", dial: "93" },
  { iso: "AL", dial: "355" },
  { iso: "DZ", dial: "213" },
  { iso: "AS", dial: "1684" },
